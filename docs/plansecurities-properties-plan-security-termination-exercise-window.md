# Plan Security Termination Exercise Window Schema
...
`object[]` ([TerminationWindow](plansecurities-properties-plan-security-termination-exercise-window-terminationwindow.md))
