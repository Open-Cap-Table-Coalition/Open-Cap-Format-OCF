...
4. `DEFINED_PER_PLAN_SECURITY` - No plan-wide default and this is handled on a
   Plan-Security-by-Plan-Security basis.
...
In order to issue something from the "2023 Stock Incentive Plan", we'll need a
[`PlanSecurityIssuance`](../../schema_markdown/schema/objects/transactions/issuance/PlanSecurityIssuance.md)
event. Let's issue an option to "Jim Jangles", our stakeholder with id
`be7d1e2e-0c9c-485b-a27d-a5c982c4e659` in the samples:
