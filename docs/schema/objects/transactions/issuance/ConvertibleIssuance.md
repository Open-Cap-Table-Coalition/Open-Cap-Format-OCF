...
| conversion_triggers     | [ [schema/types/conversion_triggers/ConvertibleTrigger](/docs/schema/types/conversion_triggers/ConvertibleTrigger.md) ]                                                               | In event the convertible can convert due to trigger events (e.g. Maturity, Next Qualified Financing, Change of Control, at Election of Holder), what are the terms?                                                                                                                                                                                                                                                                                                                                         | `REQUIRED` |
    ...
    "conversion_triggers": [
      {
        ...
        "trigger_type": "AUTOMATIC_ON_DATE",
