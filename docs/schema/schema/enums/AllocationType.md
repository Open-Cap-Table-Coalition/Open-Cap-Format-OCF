...
**Source Code:** [schema/enums/AllocationType](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/enums/AllocationType.schema.json)
