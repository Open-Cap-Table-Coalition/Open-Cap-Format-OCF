...
**Source Code:** [schema/enums/VestingDayOfMonth](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/enums/VestingDayOfMonth.schema.json)
