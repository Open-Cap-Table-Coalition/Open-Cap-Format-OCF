...
**Source Code:** [schema/types/TerminationWindow](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/types/TerminationWindow.schema.json)
