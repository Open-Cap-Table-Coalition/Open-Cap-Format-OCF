...
**Source Code:** [schema/types/CapitalizationDefinition](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/types/CapitalizationDefinition.schema.json)
