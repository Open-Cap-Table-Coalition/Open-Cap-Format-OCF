...
**Source Code:** [schema/types/vesting/VestingPeriodInDays](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/types/vesting/VestingPeriodInDays.schema.json)
