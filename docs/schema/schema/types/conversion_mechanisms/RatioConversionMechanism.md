...
| ratio         | [schema/types/Ratio](https://naveedn.github.io/Open-Cap-Format-OCF/schema/types/Ratio)                                                                     | One share of this stock class converts into this many target stock class shares | `REQUIRED` |
...
**Source Code:** [schema/types/conversion_mechanisms/RatioConversionMechanism](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/types/conversion_mechanisms/RatioConversionMechanism.schema.json)
