...
| object_type        | **Constant:** `VESTING_TERMS`</br>_Defined in [schema/enums/ObjectType](https://naveedn.github.io/Open-Cap-Format-OCF/schema/enums/ObjectType)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Object type field                                                               | `REQUIRED` |
...
| vesting_conditions | [ [schema/types/vesting/VestingCondition](https://naveedn.github.io/Open-Cap-Format-OCF/schema/types/vesting/VestingCondition) ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Conditions and triggers that describe the graph of vesting schedules and events | `REQUIRED` |

**Source Code:** [schema/objects/VestingTerms](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/objects/VestingTerms.schema.json)
