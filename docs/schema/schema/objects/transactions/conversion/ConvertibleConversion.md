...
- [schema/primitives/objects/transactions/conversion/Conversion](https://naveedn.github.io/Open-Cap-Format-OCF/schema/primitives/objects/transactions/conversion/Conversion)
...
| object_type               | **Constant:** `TX_CONVERTIBLE_CONVERSION`</br>_Defined in [schema/enums/ObjectType](https://naveedn.github.io/Open-Cap-Format-OCF/schema/enums/ObjectType)_ | Object type field                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `REQUIRED` |
...
| quantity_converted        | [schema/types/Numeric](https://naveedn.github.io/Open-Cap-Format-OCF/schema/types/Numeric)                                                                  | Quantity of security units converted                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | -          |
...
| capitalization_definition | [schema/types/CapitalizationDefinition](https://naveedn.github.io/Open-Cap-Format-OCF/schema/types/CapitalizationDefinition)                                | If this conversion event was d on the company's capitalization as calculated at the time of conversion, please specify what stock classes, stock plans and securities were included in the calculation                                                                                                                                                                                                                                                                                                      | -          |

**Source Code:** [schema/objects/transactions/conversion/ConvertibleConversion](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/objects/transactions/conversion/ConvertibleConversion.schema.json)
