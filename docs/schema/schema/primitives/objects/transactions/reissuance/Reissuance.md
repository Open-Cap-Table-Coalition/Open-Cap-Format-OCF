...
**Source Code:** [schema/primitives/objects/transactions/reissuance/Reissuance](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/primitives/objects/transactions/reissuance/Reissuance.schema.json)
