...
**Source Code:** [schema/primitives/objects/transactions/SecurityTransaction](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/primitives/objects/transactions/SecurityTransaction.schema.json)
