...
**Source Code:** [schema/primitives/types/vesting/VestingPeriod](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/primitives/types/vesting/VestingPeriod.schema.json)
