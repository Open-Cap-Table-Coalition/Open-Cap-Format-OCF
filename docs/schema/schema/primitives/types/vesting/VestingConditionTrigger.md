...
**Source Code:** [schema/primitives/types/vesting/VestingConditionTrigger](https://github.com/Open-Cap-Table-Coalition/Open-Cap-Format-OCF/blob/main/schema/primitives/types/vesting/VestingConditionTrigger.schema.json)
