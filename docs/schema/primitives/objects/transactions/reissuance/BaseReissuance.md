...
`https://opencaptablecoalition.com/schema/primitives/objects/transactions/reissuance/BaseReissuance.schema.json`
...
**Source Code:** [schema/primitives/objects/transactions/reissuance/BaseReissuance](/schema/primitives/objects/transactions/reissuance/BaseReissuance.schema.json)
