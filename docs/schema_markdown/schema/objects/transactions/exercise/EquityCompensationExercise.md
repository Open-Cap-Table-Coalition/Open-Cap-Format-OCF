...
| object_type            | **ONE OF the Following Types/Objs:**</br>&bull; **Constant:** `TX_PLAN_SECURITY_EXERCISE`</br>&bull; **Constant:** `TX_EQUITY_COMPENSATION_EXERCISE`</br>**Comment**: __This is done to avoid a breaking change as we work towards a bigger restructure of the equity types in v2.0.0__ |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `REQUIRED` |
