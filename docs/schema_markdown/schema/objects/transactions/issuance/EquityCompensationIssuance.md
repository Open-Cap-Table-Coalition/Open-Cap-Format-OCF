...
**Data Type:** `OCF Object -Multiple Supported for Backwards Compatibility`</br>- `TX_PLAN_SECURITY_ISSUANCE`
...
| object_type                  | **ONE OF the Following Types/Objs:**</br>&bull; **Constant:** `TX_PLAN_SECURITY_ISSUANCE`</br>&bull; **Constant:** `TX_EQUITY_COMPENSATION_ISSUANCE`</br>**Comment**: __This is done to avoid a breaking change as we work towards a bigger restructure of the equity types in v2.0.0__                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `REQUIRED` |
