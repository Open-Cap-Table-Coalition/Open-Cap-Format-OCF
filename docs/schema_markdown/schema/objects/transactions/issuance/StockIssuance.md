...
| issuance_type           | `Enum - Stock Issuance Type`</br></br>_Description:_ Enumeration of issuance types where we want to draw attention to some unique aspect of a stock issuance (e.g. is it an RSA)</br></br>**ONE OF:** </br>&bull; RSA | Optional field to flag certain special types of issuances (like RSAs)                                                                                                                                                                                                                                                                                                                                                                                                                                       | -          |
