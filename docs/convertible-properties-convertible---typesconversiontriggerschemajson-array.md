# Convertible - Types.ConversionTrigger.schema.json Array Schema
...
`object[]` ([ConversionTrigger](convertible-properties-convertible---typesconversiontriggerschemajson-array-conversiontrigger.md))
