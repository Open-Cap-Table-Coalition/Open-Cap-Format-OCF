...
`object` ([Vesting Schedule](captable-properties-captable---objectsvestingscheduleschemajson-array-vesting-schedule.md))
...
| [allocation_type](#allocation_type)                                       | `string`  | Required | cannot be null | [Vesting Schedule](vestingschedule-properties-enumsallocationtypeschemajson.md "Enums.AllocationType.schema.json#/properties/allocation_type")                            |
...
*   defined in: [Vesting Schedule](vestingschedule-properties-enumsallocationtypeschemajson.md "Enums.AllocationType.schema.json#/properties/allocation_type")
