...
- **OCF Manifest File**
  ...
  - **View more:** [schema/files/OCFManifestFile](/docs/schema/files/OCFManifestFile)
...
- **File - Stakeholders**
  ...
  - **View more:** [schema/files/StakeholdersFile](/docs/schema/files/StakeholdersFile)
...
- **File - Stock Classes**
  ...
  - **View more:** [schema/files/StockClassesFile](/docs/schema/files/StockClassesFile)
...
- **File - Stock Legend Templates**
  ...
  - **View more:** [schema/files/StockLegendTemplatesFile](/docs/schema/files/StockLegendTemplatesFile)
...
- **File - Stock Plans**
  ...
  - **View more:** [schema/files/StockPlansFile](/docs/schema/files/StockPlansFile)
...
- **File - Transactions**
  ...
  - **View more:** [schema/files/TransactionsFile](/docs/schema/files/TransactionsFile)
...
- **File - Valuations**
  ...
  - **View more:** [schema/files/ValuationsFile](/docs/schema/files/ValuationsFile)
...
- **File - Vesting Terms**
  ...
  - **View more:** [schema/files/VestingTermsFile](/docs/schema/files/VestingTermsFile)
...
- **Object - Issuer**
  ...
  - **View more:** [schema/objects/Issuer](/docs/schema/objects/Issuer)

- **Object - Stakeholder**

  - **Id:** `https://opencaptablecoalition.com/schema/objects/Stakeholder.schema.json`
  - **Description:** Object describing a stakeholder
  - **View more:** [schema/objects/Stakeholder](/docs/schema/objects/Stakeholder)
...
- **Object - Stock Class**
  ...
  - **View more:** [schema/objects/StockClass](/docs/schema/objects/StockClass)
...
- **Object - Stock Legend Template**
  ...
  - **View more:** [schema/objects/StockLegendTemplate](/docs/schema/objects/StockLegendTemplate)
...
- **Object - Stock Plan**
  ...
  - **View more:** [schema/objects/StockPlan](/docs/schema/objects/StockPlan)
...
- **Object - Valuation**
  ...
  - **View more:** [schema/objects/Valuation](/docs/schema/objects/Valuation)
...
- **Object - Vesting Terms**
  ...
  - **View more:** [schema/objects/VestingTerms](/docs/schema/objects/VestingTerms)
...
- **Object - Vesting Event Transaction**
  ...
  - **View more:** [schema/objects/transactions/vesting/VestingEvent](/docs/schema/objects/transactions/vesting/VestingEvent)
...
- **Object - Vesting Start Transaction**
  ...
  - **View more:** [schema/objects/transactions/vesting/VestingStart](/docs/schema/objects/transactions/vesting/VestingStart)
...
- **Object - Convertible Transfer Transaction**
  ...
  - **View more:** [schema/objects/transactions/transfer/ConvertibleTransfer](/docs/schema/objects/transactions/transfer/ConvertibleTransfer)
...
- **Object - Plan Security Transfer Transaction**
  ...
  - **View more:** [schema/objects/transactions/transfer/PlanSecurityTransfer](/docs/schema/objects/transactions/transfer/PlanSecurityTransfer)
...
- **Object - Stock Transfer Transaction**
  ...
  - **View more:** [schema/objects/transactions/transfer/StockTransfer](/docs/schema/objects/transactions/transfer/StockTransfer)
...
- **Object - Warrant Transfer Transaction**
  ...
  - **View more:** [schema/objects/transactions/transfer/WarrantTransfer](/docs/schema/objects/transactions/transfer/WarrantTransfer)
...
- **Object - Stock Split Transaction**
  ...
  - **View more:** [schema/objects/transactions/split/StockClassSplit](/docs/schema/objects/transactions/split/StockClassSplit)
...
- **Object - Convertible Retraction Transaction**
  ...
  - **View more:** [schema/objects/transactions/retraction/ConvertibleRetraction](/docs/schema/objects/transactions/retraction/ConvertibleRetraction)
...
- **Object - Plan Security Retraction Transaction**
  ...
  - **View more:** [schema/objects/transactions/retraction/PlanSecurityRetraction](/docs/schema/objects/transactions/retraction/PlanSecurityRetraction)
...
- **Object - Stock Retraction Transaction**
  ...
  - **View more:** [schema/objects/transactions/retraction/StockRetraction](/docs/schema/objects/transactions/retraction/StockRetraction)
...
- **Object - Warrant Retraction Transaction**
  ...
  - **View more:** [schema/objects/transactions/retraction/WarrantRetraction](/docs/schema/objects/transactions/retraction/WarrantRetraction)
...
- **Object - Stock Repurchase Transaction**
  ...
  - **View more:** [schema/objects/transactions/repurchase/StockRepurchase](/docs/schema/objects/transactions/repurchase/StockRepurchase)
...
- **Object - Plan Security Release Transaction**
  ...
  - **View more:** [schema/objects/transactions/release/PlanSecurityRelease](/docs/schema/objects/transactions/release/PlanSecurityRelease)
...
- **Object - Stock Re-issuance Transaction**
  ...
  - **View more:** [schema/objects/transactions/reissuance/StockReissuance](/docs/schema/objects/transactions/reissuance/StockReissuance)
...
- **Object - Convertible Issuance Transaction**
  ...
  - **View more:** [schema/objects/transactions/issuance/ConvertibleIssuance](/docs/schema/objects/transactions/issuance/ConvertibleIssuance)
...
- **Object - Plan Security Issuance Transaction**
  ...
  - **View more:** [schema/objects/transactions/issuance/PlanSecurityIssuance](/docs/schema/objects/transactions/issuance/PlanSecurityIssuance)
...
- **Object - Stock Issuance Transaction**
  ...
  - **View more:** [schema/objects/transactions/issuance/StockIssuance](/docs/schema/objects/transactions/issuance/StockIssuance)
...
- **Object - Warrant Issuance Transaction**
  ...
  - **View more:** [schema/objects/transactions/issuance/WarrantIssuance](/docs/schema/objects/transactions/issuance/WarrantIssuance)
...
- **Object - Plan Security Exercise Transaction**
  ...
  - **View more:** [schema/objects/transactions/exercise/PlanSecurityExercise](/docs/schema/objects/transactions/exercise/PlanSecurityExercise)
...
- **Object - Warrant Exercise Transaction**
  ...
  - **View more:** [schema/objects/transactions/exercise/WarrantExercise](/docs/schema/objects/transactions/exercise/WarrantExercise)
...
- **Object - Convertible Conversion Transaction**
  ...
  - **View more:** [schema/objects/transactions/conversion/ConvertibleConversion](/docs/schema/objects/transactions/conversion/ConvertibleConversion)
...
- **Object - Stock Conversion Transaction**
  ...
  - **View more:** [schema/objects/transactions/conversion/StockConversion](/docs/schema/objects/transactions/conversion/StockConversion)
...
- **Object - Convertible Cancellation Transaction**
  ...
  - **View more:** [schema/objects/transactions/cancellation/ConvertibleCancellation](/docs/schema/objects/transactions/cancellation/ConvertibleCancellation)
...
- **Object - Plan Security Cancellation Transaction**
  ...
  - **View more:** [schema/objects/transactions/cancellation/PlanSecurityCancellation](/docs/schema/objects/transactions/cancellation/PlanSecurityCancellation)
...
- **Object - Stock Cancellation Transaction**
  ...
  - **View more:** [schema/objects/transactions/cancellation/StockCancellation](/docs/schema/objects/transactions/cancellation/StockCancellation)
...
- **Object - Warrant Cancellation Transaction**
  ...
  - **View more:** [schema/objects/transactions/cancellation/WarrantCancellation](/docs/schema/objects/transactions/cancellation/WarrantCancellation)
...
- **Object - Convertible Acceptance Transaction**
  ...
  - **View more:** [schema/objects/transactions/acceptance/ConvertibleAcceptance](/docs/schema/objects/transactions/acceptance/ConvertibleAcceptance)
...
- **Object - Plan Security Acceptance Transaction**
  ...
  - **View more:** [schema/objects/transactions/acceptance/PlanSecurityAcceptance](/docs/schema/objects/transactions/acceptance/PlanSecurityAcceptance)
...
- **Object - Stock Acceptance Transaction**
  ...
  - **View more:** [schema/objects/transactions/acceptance/StockAcceptance](/docs/schema/objects/transactions/acceptance/StockAcceptance)
...
- **Object - Warrant Acceptance Transaction**
  ...
  - **View more:** [schema/objects/transactions/acceptance/WarrantAcceptance](/docs/schema/objects/transactions/acceptance/WarrantAcceptance)
...
- **Enum - Accrual Period Type**
  ...
  - **View more:** [schema/enums/AccrualPeriodType](/docs/schema/enums/AccrualPeriodType)

- **Enum - Address Type**

  - **Id:** `https://opencaptablecoalition.com/schema/enums/AddressType.schema.json`
  - **Description:** Enumeration of address types
  - **View more:** [schema/enums/AddressType](/docs/schema/enums/AddressType)
...
- **Enum - Allocation Type**
  ...
  - **View more:** [schema/enums/AllocationType](/docs/schema/enums/AllocationType)
...
- **Enum - Compensation Type**
  ...
  - **View more:** [schema/enums/CompensationType](/docs/schema/enums/CompensationType)
...
- **Enum - Compounding Type**
  ...
  - **View more:** [schema/enums/CompoundingType](/docs/schema/enums/CompoundingType)
...
- **Enum - Conversion Mechanism Type**
  ...
  - **View more:** [schema/enums/ConversionMechanismType](/docs/schema/enums/ConversionMechanismType)
...
- **Enum - Conversion Right Type**
  ...
  - **View more:** [schema/enums/ConversionRightType](/docs/schema/enums/ConversionRightType)
...
- **Enum - Trigger Type**
  ...
  - **View more:** [schema/enums/ConversionTriggerType](/docs/schema/enums/ConversionTriggerType)
...
- **Enum - Convertible Type**
  ...
  - **View more:** [schema/enums/ConvertibleType](/docs/schema/enums/ConvertibleType)
...
- **Enum - Day Count Type**
  ...
  - **View more:** [schema/enums/DayCountType](/docs/schema/enums/DayCountType)

- **Enum - Email Type**

  - **Id:** `https://opencaptablecoalition.com/schema/enums/EmailType.schema.json`
  - **Description:** Enumeration of email types
  - **View more:** [schema/enums/EmailType](/docs/schema/enums/EmailType)
...
- **Enum - OCF File Type**
  ...
  - **View more:** [schema/enums/FileType](/docs/schema/enums/FileType)
...
- **Enum - Interest Payout Type**
  ...
  - **View more:** [schema/enums/InterestPayoutType](/docs/schema/enums/InterestPayoutType)
...
- **Enum - Stakeholder Relationship Type**
  ...
  - **View more:** [schema/enums/StakeholderRelationshipType](/docs/schema/enums/StakeholderRelationshipType)
...
- **Enum - Stakeholder Type**
  ...
  - **View more:** [schema/enums/StakeholderType](/docs/schema/enums/StakeholderType)
...
- **Enum - Stock Class Type**
  ...
  - **View more:** [schema/enums/StockClassType](/docs/schema/enums/StockClassType)
...
- **Enum - Termination Window Type**
  ...
  - **View more:** [schema/enums/TerminationWindowType](/docs/schema/enums/TerminationWindowType)

- **Enum - Valuation Type**

  - **Id:** `https://opencaptablecoalition.com/schema/enums/ValuationType.schema.json`
  - **Description:** Enumeration of valuation types
  - **View more:** [schema/enums/ValuationType](/docs/schema/enums/ValuationType)
...
- **Enum - Vesting Day of Month**
  ...
  - **View more:** [schema/enums/VestingDayOfMonth](/docs/schema/enums/VestingDayOfMonth)
...
- **Enum - Vesting Trigger Type**
  ...
  - **View more:** [schema/enums/VestingTriggerType](/docs/schema/enums/VestingTriggerType)
...
- **Type - Address**
  ...
  - **View more:** [schema/types/Address](/docs/schema/types/Address)
...
- **Type - Capitalization Definition**
  ...
  - **View more:** [schema/types/CapitalizationDefinition](/docs/schema/types/CapitalizationDefinition)
...
- **Type - Contact Info**
  ...
  - **View more:** [schema/types/ContactInfo](/docs/schema/types/ContactInfo)
...
- **Type - Country Code**
  ...
  - **View more:** [schema/types/CountryCode](/docs/schema/types/CountryCode)
...
- **Type - Country Subdivision Code**
  ...
  - **View more:** [schema/types/CountrySubdivisionCode](/docs/schema/types/CountrySubdivisionCode)
...
- **Type - Currency Code**
  ...
  - **View more:** [schema/types/CurrencyCode](/docs/schema/types/CurrencyCode)
...
- **Type - MD5 Hash**
  ...
  - **View more:** [schema/types/Md5](/docs/schema/types/Md5)
...
- **Type - Numeric**
  ...
  - **View more:** [schema/types/Numeric](/docs/schema/types/Numeric)
...
- **Type - Percentage**
  ...
  - **View more:** [schema/types/Percentage](/docs/schema/types/Percentage)

- **Type - Phone**

  - **Id:** `https://opencaptablecoalition.com/schema/types/Phone.schema.json`
  - **Description:** Type representation of a phone number
  - **View more:** [schema/types/Phone](/docs/schema/types/Phone)
...
- **Type - Pre-Release Omission**
  ...
  - **View more:** [schema/types/PreReleaseOmission](/docs/schema/types/PreReleaseOmission)
...
- **Type - Ratio**
  ...
  - **View more:** [schema/types/Ratio](/docs/schema/types/Ratio)
...
- **Type - Security Exemption**
  ...
  - **View more:** [schema/types/SecurityExemption](/docs/schema/types/SecurityExemption)
...
- **Type - Stock Parent**
  ...
  - **View more:** [schema/types/StockParent](/docs/schema/types/StockParent)
...
- **Type - Tax Identifier**
  ...
  - **View more:** [schema/types/TaxID](/docs/schema/types/TaxID)
...
- **Type - Termination Window**
  ...
  - **View more:** [schema/types/TerminationWindow](/docs/schema/types/TerminationWindow)
...
- **Type - Vesting Condition**
  ...
  - **View more:** [schema/types/vesting/VestingCondition](/docs/schema/types/vesting/VestingCondition)
...
- **Type - Vesting Condition Portion**
  ...
  - **View more:** [schema/types/vesting/VestingConditionPortion](/docs/schema/types/vesting/VestingConditionPortion)
...
- **Type - Vesting Event Trigger**
  ...
  - **View more:** [schema/types/vesting/VestingEventTrigger](/docs/schema/types/vesting/VestingEventTrigger)
...
- **Type - Vesting Period in Days**
  ...
  - **View more:** [schema/types/vesting/VestingPeriodInDays](/docs/schema/types/vesting/VestingPeriodInDays)
...
- **Type - Vesting Period in Months**
  ...
  - **View more:** [schema/types/vesting/VestingPeriodInMonths](/docs/schema/types/vesting/VestingPeriodInMonths)
...
- **Type - Vesting Schedule Absolute Trigger**
  ...
  - **View more:** [schema/types/vesting/VestingScheduleAbsoluteTrigger](/docs/schema/types/vesting/VestingScheduleAbsoluteTrigger)
...
- **Type - Vesting Schedule Relative Trigger**
  ...
  - **View more:** [schema/types/vesting/VestingScheduleRelativeTrigger](/docs/schema/types/vesting/VestingScheduleRelativeTrigger)
...
- **Type - Vesting Start Trigger**
  ...
  - **View more:** [schema/types/vesting/VestingStartTrigger](/docs/schema/types/vesting/VestingStartTrigger)
...
- **Type - Automatic Conversion on Condition Trigger**
  ...
  - **View more:** [schema/types/conversion_triggers/AutomaticConversionOnConditionTrigger](/docs/schema/types/conversion_triggers/AutomaticConversionOnConditionTrigger)
...
- **Type - Automatic Conversion on Date Trigger**
  ...
  - **View more:** [schema/types/conversion_triggers/AutomaticConversionOnDateTrigger](/docs/schema/types/conversion_triggers/AutomaticConversionOnDateTrigger)
...
- **Type - Elective Conversion At Will**
  ...
  - **View more:** [schema/types/conversion_triggers/ElectiveConversionAtWillTrigger](/docs/schema/types/conversion_triggers/ElectiveConversionAtWillTrigger)
...
- **Type - Elective Conversion In Date Range Trigger**
  ...
  - **View more:** [schema/types/conversion_triggers/ElectiveConversionInDateRangeTrigger](/docs/schema/types/conversion_triggers/ElectiveConversionInDateRangeTrigger)
...
- **Type - Elective Conversion on Condition Trigger**
  ...
  - **View more:** [schema/types/conversion_triggers/ElectiveConversionOnConditionTrigger](/docs/schema/types/conversion_triggers/ElectiveConversionOnConditionTrigger)
...
- **Type - Unspecified Conversion Trigger**
  ...
  - **View more:** [schema/types/conversion_triggers/UnspecifiedConversionTrigger](/docs/schema/types/conversion_triggers/UnspecifiedConversionTrigger)
...
- **Type - Convertible Conversion Rights**
  ...
  - **View more:** [schema/types/conversion_rights/ConvertibleConversionRight](/docs/schema/types/conversion_rights/ConvertibleConversionRight)
...
- **Type - Stock Class Conversion Rights**
  ...
  - **View more:** [schema/types/conversion_rights/StockClassConversionRight](/docs/schema/types/conversion_rights/StockClassConversionRight)
...
- **Type - Warrant Conversion Rights**
  ...
  - **Description:** Type representation of a conversion right from a convertible into another non-plan security
  - **View more:** [schema/types/conversion_rights/WarrantConversionRight](/docs/schema/types/conversion_rights/WarrantConversionRight)
...
- **Conversion Mechanism - Custom**
  ...
  - **View more:** [schema/types/conversion_mechanisms/CustomConversionMechanism](/docs/schema/types/conversion_mechanisms/CustomConversionMechanism)
...
- **Conversion Mechanism - Fixed Amount**
  ...
  - **View more:** [schema/types/conversion_mechanisms/FixedAmountConversionMechanism](/docs/schema/types/conversion_mechanisms/FixedAmountConversionMechanism)
...
- **Conversion Mechanism - Note**
  ...
  - **View more:** [schema/types/conversion_mechanisms/NoteConversionMechanism](/docs/schema/types/conversion_mechanisms/NoteConversionMechanism)
...
- **Conversion Mechanism - Percent of Capitalization**
  ...
  - **View more:** [schema/types/conversion_mechanisms/PercentCapitalizationConversionMechanism](/docs/schema/types/conversion_mechanisms/PercentCapitalizationConversionMechanism)
...
- **Conversion Mechanism - Ratio**
  ...
  - **View more:** [schema/types/conversion_mechanisms/RatioConversionMechanism](/docs/schema/types/conversion_mechanisms/RatioConversionMechanism)
...
- **Conversion Mechanism - SAFE**
  ...
  - **View more:** [schema/types/conversion_mechanisms/SAFEConversionMechanism](/docs/schema/types/conversion_mechanisms/SAFEConversionMechanism)
...
- **Primitive - Vesting Condition Trigger Type**
  ...
  - **View more:** [schema/primitives/types/vesting/VestingConditionTrigger](/docs/schema/primitives/types/vesting/VestingConditionTrigger)
...
- **Primitive - Vesting Period Type**
  ...
  - **View more:** [schema/primitives/types/vesting/VestingPeriod](/docs/schema/primitives/types/vesting/VestingPeriod)
...
- **Primitive - Conversion Trigger Type**
  ...
  - **View more:** [schema/primitives/types/conversion_triggers/ConversionTrigger](/docs/schema/primitives/types/conversion_triggers/ConversionTrigger)
...
- **Primitive - Conversion Right Type**
  ...
  - **View more:** [schema/primitives/types/conversion_rights/ConversionRight](/docs/schema/primitives/types/conversion_rights/ConversionRight)
...
- **Primitive - Conversion Mechanism Type**
  ...
  - **View more:** [schema/primitives/types/conversion_mechanisms/ConversionMechanism](/docs/schema/primitives/types/conversion_mechanisms/ConversionMechanism)
...
- **Primitive - Object**
  ...
  - **View more:** [schema/primitives/objects/Object](/docs/schema/primitives/objects/Object)
...
- **Primitive - Security Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/SecurityTransaction](/docs/schema/primitives/objects/transactions/SecurityTransaction)
...
- **Primitive - Stock Class Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/StockClassTransaction](/docs/schema/primitives/objects/transactions/StockClassTransaction)
...
- **Primitive - Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/Transaction](/docs/schema/primitives/objects/transactions/Transaction)
...
- **Primitive - Security Transfer Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/transfer/Transfer](/docs/schema/primitives/objects/transactions/transfer/Transfer)
...
- **Primitive - Security Retraction Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/retraction/Retraction](/docs/schema/primitives/objects/transactions/retraction/Retraction)
...
- **Primitive - Security Repurchase Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/repurchase/Repurchase](/docs/schema/primitives/objects/transactions/repurchase/Repurchase)
...
- **Primitive - Security Release Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/release/Release](/docs/schema/primitives/objects/transactions/release/Release)
...
- **Primitive - Security Reissuance Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/reissuance/Reissuance](/docs/schema/primitives/objects/transactions/reissuance/Reissuance)
...
- **Primitive - Security Issuance Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/issuance/Issuance](/docs/schema/primitives/objects/transactions/issuance/Issuance)
...
- **Primitive - Security Exercise Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/exercise/Exercise](/docs/schema/primitives/objects/transactions/exercise/Exercise)
...
- **Primitive - Security Conversion Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/conversion/Conversion](/docs/schema/primitives/objects/transactions/conversion/Conversion)
...
- **Primitive - Security Cancellation Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/cancellation/Cancellation](/docs/schema/primitives/objects/transactions/cancellation/Cancellation)
...
- **Primitive - Security Acceptance Transaction**
  ...
  - **View more:** [schema/primitives/objects/transactions/acceptance/Acceptance](/docs/schema/primitives/objects/transactions/acceptance/Acceptance)
...
- **Object - File**
  ...
  - **View more:** [schema/primitives/files/File](/docs/schema/primitives/files/File)
