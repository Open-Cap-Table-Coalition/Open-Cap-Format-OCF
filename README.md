...
2. `enums` definitions
    ...
    | [DayCount Type](docs/daycount.md)                          | `Enums.DayCount.schema.json`          | Enumeration of ways days are determine per period                                                                                            |
...
3. `types` used as common building blocks
    ...
    | [PhoneNumber](docs/phonenumber.md)                                          | `Types.PhoneNumber.schema.json`                      | Type representation of a phone number                                                                                                                                |
