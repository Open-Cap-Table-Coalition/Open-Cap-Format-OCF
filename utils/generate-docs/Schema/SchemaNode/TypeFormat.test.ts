...
const FIXTURE: TypeFormatSchemaNodeJson = {
  $id: "https://opencaptablecoalition.com/schema/types/test_type_format",
  title: "Test Title",
  description:
...
\`https://opencaptablecoalition.com/schema/types/test_type_format\`
...
**Source Code:** [schema/types/test_type_format](/schema/types/TestTypeFormat.schema.json)
