...
```txt
Objects.Transactions.Transfer.ConvertibleTransfer.schema.json#/properties/transactions/items/oneOf/15
```
...
`object` ([Object - Convertible Transfer Transaction](captable-properties-captable---objectstransactionsschemajson-array-items-oneof-object---convertible-transfer-transaction.md))
